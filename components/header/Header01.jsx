          ...
          <div className="js-mobile-menu dark:bg-jacarta-800 invisible fixed inset-0 z-10 ml-auto items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent" id="header">
            ...
            <div className="ml-8 hidden items-center lg:flex xl:ml-12">
              ...
              <div className="js-nav-dropdown group-dropdown relative">
                <button className="border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent ml-2 flex items-center justify-center border transition-colors hover:border-transparent focus:border-transparent dark:border-transparent" 
                    style={{
                      width: '150px',
                      background: '#00c4cf',
                      height: '40px',
