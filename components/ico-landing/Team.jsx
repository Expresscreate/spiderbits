const Team = () => {
  ...
  return (
    <section className="relative py-24" id="ourteam">
      ...
      <picture className="pointer-events-none absolute inset-0 -z-10 hidden dark:block">
        <img
          src="/images/gradient_dark-team.jpg"
          alt="gradient dark"
          className=""
        />
      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-xl text-center">
          <h2 className="mb-6 text-center font-display text-3xl font-medium text-jacarta-700 dark:text-white">
             Team Members Behind this Project
          </h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-3 md:gap-[1.875rem] lg:grid-cols-3">
