          ...
          <div className="flex space-x-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 512 512"
              >
                <path d="M256,6C117.1,6,4,118.6,4,257s113.1,251,252,251s252-112.6,252-251S394.9,6,256,6z M380.4,115.4l-56.5,265.5
	c-3.2,17.7-14.5,22.5-30.7,14.5l-77.5-56.3l-35.5,37c-4.8,3.2-8.1,8-16.2,8l4.8-77.2l142.1-128.7c6.5-4.8-1.6-8-9.7-3.2L125.1,287.6
	l6.5-72.4L380.4,115.4z"/>
              </svg>
            </a>
