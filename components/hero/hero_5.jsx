...
const Hero_5 = () => {
	return (
		<>
			{/* <!-- Hero --> */}
			<section className="relative py-20 md:pt-32" id="header">
				<picture className="pointer-events-none absolute inset-0 -z-10 dark:hidden">
					<img src="/images/gradient.jpg" alt="gradient" className="h-full" />
				</picture>
				<picture className="pointer-events-none absolute inset-0 -z-10 hidden dark:block" style={{background: "linear-gradient(#20046b 85%, #7a0162 100%)"}}>
					<img src="/images/gradient_dark.jpg" alt="gradient dark" className="" />
				</picture>
					...
					<div className="grid h-full items-center gap-4 lg:grid-cols-12">
						<div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-5 xl:pl-[20%] xl:pr-[10%]">
							...
							<h1 className="mb-6 text-center font-display text-5xl text-jacarta-700 dark:text-white md:text-left lg:text-5xl xl:text-6xl">
								Collect NFT &apos;s & Join Our Crypto Lottery.
							</h1>
							<p className="mb-8 text-center text-lg dark:text-jacarta-200 md:text-left">
							Welcome to SpiderBits, a web3 gamefi lottery plateform that is redefining the traditional lottery experience through the integration of blockchain technology and non-fungible
tokens (NFTs).
							</p>
							<div className="flex space-x-4">
								<Link href="#">
									<a className="w-36 rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark" style={{width: '220px'}}>
										JOIN THE PRESALE
									</a>
								</Link>
